...
1. Explore the repo to understand the current state of the codebase, if you haven't already. Use the project's domain glossary vocabulary from `.scratch/context.md` throughout the spec, if one exists.
